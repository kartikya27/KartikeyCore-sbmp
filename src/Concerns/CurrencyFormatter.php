...
namespace Kartikey\Core\Concerns;
...
trait CurrencyFormatter
{
     ...
     *
     * @param  string|\Kartikey\Core\Interface\Currency  $currency
     */
    public function currencySymbol($currency): string
    {
        $code = $currency instanceof \Kartikey\Core\Interface\Currency ? $currency->code : $currency;
